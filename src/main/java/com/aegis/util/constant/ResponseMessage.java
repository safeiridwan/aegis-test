package com.aegis.util.constant;
...
public class ResponseMessage {
    ...
    // 400
    public static final String BAD_REQUEST = "Your request is in a bad format.";
    ...
    // 500
    public static final String SERVER_ERROR = "We encountered an error while processing your request.";
